...
![版本](https://img.shields.io/badge/版本-1.0.1-E46845)
...
- 页面展示：[页面展示](./docs/page-display.md)
...
- 左侧栏顶部提供一个设置按钮
- 可以在设置弹窗中切换会话目录，以及切换界面语言（中文 / English）
- 应用首次安装后的首次打开会自动弹出设置，之后不会再自动弹出
